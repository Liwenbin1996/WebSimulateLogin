#!/usr/bin/ python
# -*- coding: utf-8 -*-
# @Time    : 2022/8/25 6:08 PM
# @Author  : Liwenbin
# @File    : ocr.py
# @Project: WebSimulateLogin
# @Description: ocr means Optical Character Recognition, Code is quoted from https://github.com/sml2h3/ddddocr
import io
import os
import base64
import json
